...
def lookup_plant(plant_name: str) -> dict:
    ...
    # 2–4. Search all plants by display name, scientific name, aliases
    ...
    return {
        "found": False,
        "name": normalized,
        "message": f"No plant matching '{normalized}' was found. Try a common name, scientific name, or alias.",
    }
